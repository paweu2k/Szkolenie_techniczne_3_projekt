...
namespace Szkolenie_techniczne_3_projekt.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,imie,nazwisko,ulica,numer_domu,email")] Students students)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("id,imie,nazwisko,ulica,numer_domu,email")] Students students)
        {
            if (id != students.id)
            {
                return NotFound();
